...
<body style="margin:0;padding:0; background:#fff  url(images/bg.jpg) no-repeat top left; font-family: Arial, Verdana, Sans-Serif;"> 
    ...
    <div style="position: relative;margin-top:0px; margin-bottom: 0px; top: 0px; left: 0px; width:105%; text-align: center; background-image: url(img/home/back-dice-02.jpg); overflow:hidden;">
        <!-- Jssor Slider Begin -->
        <!-- To move inline styles to css file/block, please specify a class name for each element. -->  
        <div id="sliderc_container" style="position: relative; margin: 0 auto; width: 960px;
            height: 400px; text-align: left; overflow:hidden;">
            ...
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 960px; height: 450px;
                ...
                <div>
                    <!-- Jssor Slider Begin -->
                    <!-- To move inline styles to css file/block, please specify a class name for each element. --> 
                    <div id="slider1_container" style="position: relative; top: 50px; left: 0px; width: 600px;
                ...
                <div>
                    ...
                    <a class="captionTextBlack" u="caption" t="CLIP|L" d="-200" href="http://www.jssor.com/development/tool-caption-transition-viewer.html"
                        style="position: absolute; top: 30px; left: 0px; width: 320px; height: 30px; font-size: 26px; background-color:transparent;">E-Commerce Websites</a>

                    <div u="caption" t="ZM" t2="NO" style="position: absolute; top: 80px; left: 0px; width: 320px; height: 80px;">
                        <div u="caption" t2="TEAM_2" class="captionOrange" style="position: absolute; top: 0px; left: 20px; width: 200px; height: 30px;">
                            Lower Cost
                        </div>            
                    ...
                    <a class="captionTextBlack" u="caption" t="L|EP" href="http://www.jssor.com/development/tool-slideshow-transition-viewer.html"
                        style="position: absolute; top: 210px; left: 0px; width: 320px; height: 30px; font-size: 26px; background-color:transparent;">Smartphones</a>

                    <div u="caption" t="B*IB" t2="NO" style="position: absolute; top: 260px; left: 0px; width: 320px; height: 80px;">
                        <div u="caption" t2="TEAM_2" class="captionOrange" style="position: absolute; top: 0px; left: 40px; width: 200px; height: 30px;">
                          Mobile Apps
                        </div>
                        <div u="caption" t2="TEAM_2" class="captionBlack" style="position: absolute; top: 40px; left: 0px; width: 100px; height: 30px;">
                            Games
                        </div>
                        <div u="caption" t2="TEAM_2" class="captionBlack" style="position: absolute; top: 40px; left: 130px; width: 210px; height: 30px;">
                            Entertainment
                        </div>
                    </div>
                </div>
